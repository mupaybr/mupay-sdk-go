...
func TestRefundCreateCorrelatesKnownRequestFields(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			body:     `{"refund_id":"refund_1","charge_id":"charge_1","amount_cents":100,"status":"pending"}`,
		...
		},
		{
			...
			chargeID:    "charge_1",
			params:      mupag.RefundCreateParams{AmountCents: &partialAmount},
			body:        `{"refund_id":"refund_1","charge_id":"charge_2","amount_cents":100,"status":"pending"}`,
		...
		},
		{
			...
			chargeID:    "charge_1",
			params:      mupag.RefundCreateParams{AmountCents: &partialAmount},
			body:        `{"refund_id":"refund_1","charge_id":"charge_1","amount_cents":200,"status":"pending"}`,
		...
		},
		{
			...
			body:     `{"refund_id":"refund_1","charge_id":"charge_1","amount_cents":275,"status":"pending"}`,
		...
		},
		{
			...
			chargeID:    "charge_1",
			params:      mupag.RefundCreateParams{Full: true},
			body:        `{"refund_id":"refund_1","charge_id":"charge_2","amount_cents":275,"status":"pending"}`,
